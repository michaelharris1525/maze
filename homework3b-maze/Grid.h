...
//hold the values for each cell in the grid
        std::vector<int> spaces;
//spaces.reserve preallocates memory for spaces. Reserves space for the entire grid
    ...
    //     void print() {
    // // Iterate through the three dimensions: depth, height, and width.
    //         for (size_t d = 0; d < depth_; ++d) {
    //             std::cout << "Layer " << d << ":\n";
    //         for (size_t r = 0; r < height_; ++r) {
    //             for (size_t c = 0; c < width_; ++c) {
    //                 // Calculate the index for the current position.
    //                 size_t index = d * width_ * height_ + r * width_ + c;
